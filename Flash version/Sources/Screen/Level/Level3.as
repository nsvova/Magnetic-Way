...
//	import flash.display.NativeMenu;
	...
	public class Level3 extends Game
	{
		...
		public function Level3(sp:Sprite) 
		{
			super(sp, 3);
			...
			CreateStaticBox(540, 330, 200, 30, new UserData( -1, "floor"));
			CreateStaticBox(160, 230, 300, 30, new UserData( -1, "floor"));
			
			CreateStaticBox(320, 20, 80, 10, new UserData( -1, "winWall"));
			
			
			CreatePersone(140, 440, 20);
			
			bonus.CreateBonus(200, 260, 10, 1);
			bonus.CreateBonus(560, 120, 10, 1);
			bonus.CreateBonus(320, 80, 10, 1);
			
			AddRadius();
			
			help = FlashGrafic.CreateText("The ball takes energy from \nspecial metal floor" ,
												0, 80, 28, 0xffffff, "Comic Sans MS");
			addChild(help);
