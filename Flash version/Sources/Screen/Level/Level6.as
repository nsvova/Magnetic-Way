...
//	import flash.display.NativeMenu;
	...
	public class Level6 extends Game
	{
		...
		public function Level6(sp:Sprite) 
		{
			super(sp, 6);
			...
			CreateStaticBox(540, 130, 200, 25, new UserData( -1, "floor"));
			CreateStaticBox(100, 350, 200, 25, new UserData( -1, "floor"));
			
			CreateStaticBox(620, 70, 10, 80, new UserData( -1, "winWall"));
			
			var rope:Rope = new Rope(this);
			rope.CreateRopeWithHook(_world, 160, 220, 40, worldScale);
			
			CreatePersone(290, 440, 20);
			
			bonus.CreateBonus(420, 210, 10, 1);
			bonus.CreateBonus(160, 40, 10, 1);
			bonus.CreateBonus(420, 150, 10, 1);
