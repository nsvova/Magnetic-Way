...
//	import flash.display.NativeMenu;
	...
	public class Level9 extends Game
	{
		...
		public function Level9(sp:Sprite) 
		{
			super(sp, 9);
			...
			CreateStaticBox(120, 475, 240, 35, new UserData( -1, "floor"));
			CreateStaticBox(5, 240, 10, 480,new UserData(-1, "wall"));
			CreateStaticBox(635, 240, 10, 480, new UserData( -1, "wall"));
			
			CreateStaticBox(610, 170, 25, 340, new UserData( -1, "floor"));
			CreateStaticBox(450, 80, 10, 80, new UserData( -1, "die"));
			
			
			CreateStaticBox(540, 30, 80, 10, new UserData( -1, "winWall"));
			
			var rope:Rope = new Rope(this);
			rope.CreateRopeWithHook(_world, 180, 320, 40, worldScale);
			
			CreateStaticBox(435, 470, 390, 10, new UserData( -1, "die"));
			
			CreatePersone(160, 440, 20);
			
			bonus.CreateBonus(580, 420, 10, 1);
			bonus.CreateBonus(480, 90, 10, 1);
